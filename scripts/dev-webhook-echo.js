    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 12:
                ...
                res.end(JSON.stringify({ status: 'ok', payload: payload }));
                return [2 /*return*/];
        }
    });
}); });
server.listen(port, function () {
    console.log("Dev webhook echo listening on http://localhost:".concat(port));
});
