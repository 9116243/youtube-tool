...
const RATE_1080 = dollarsToCents(appEnv.LUMA_PRICE_PER_MIN_1080 ?? 0);
const RATE_2K = dollarsToCents(appEnv.LUMA_PRICE_PER_MIN_2K ?? 0);
const RATE_4K = dollarsToCents(appEnv.LUMA_PRICE_PER_MIN_4K ?? 0);
